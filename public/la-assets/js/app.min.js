...
$(document).ready(function() {
    function showLAFM(type, selector) {
        ...
        $.ajax({
            dataType: 'json',
            url: $('body').attr("bsurl")+"/la/folder_files/uploads",
            success: function ( json ) {
                ...
                for (var index = 0; index < json.files.length; index++) {
                    ...
                    var li = '<li><a class="fm_file_sel" data-toggle="tooltip" data-placement="top" title="'+json.folder_name+'/'+element+'" fpath="'+json.folder_name+'/'+element+'"><img src="'+bsurl+'/'+json.folder_name+'/'+element+'"></a></li>';
