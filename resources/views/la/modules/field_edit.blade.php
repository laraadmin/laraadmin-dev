...
@section("section_url", url('/la/modules/'.$module->id))
	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				{!! Form::model($field, ['route' => ['la.module_fields.update', $field->id ], 'method'=>'PUT', 'id' => 'field-edit-form']) !!}
                    ...
                    <br>
					<div class="form-group">
						{!! Form::submit( 'Update', ['class'=>'btn btn-success']) !!} <button class="btn btn-default pull-right"><a href="{{ url('/la/modules/'.$module->id) }}">Cancel</a></button>
					</div>
				{!! Form::close() !!}
